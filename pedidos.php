...
unset($_SESSION['pedidos']); // Limpiar la sesión para evitar la visualización repetida
            ...
            <tbody>
                <?php foreach ($pedidos as $pedido): ?>
                    <tr>
                        ...
                        <td>
                            <button onclick="openModal('<?php echo $pedido['FolioPedido']; ?>', '<?php echo htmlspecialchars($pedido['TituloLibro']); ?>', '<?php echo htmlspecialchars($pedido['Autor']); ?>', '<?php echo htmlspecialchars($pedido['Precio']); ?>', '<?php echo htmlspecialchars($pedido['FechaPedido']); ?>')">Modificar</button>
                        </td>
                        <td>
                            <form action="eliminarPedido.php" method="post">
                                <input type="hidden" name="folio" value="<?php echo htmlspecialchars($pedido['FolioPedido']); ?>">
